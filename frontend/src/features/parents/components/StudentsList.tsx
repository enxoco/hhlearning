...
export default function StudentsList({ id, lastName, students, setParentName, setParentId, onOpen }: IStudentsListProps){
    return (
        ...
        <Tooltip label="Add Children" ml="auto">
          ...
          <IconButton aria-label="Add Children" icon={<FiPlusCircle size="sm" />} color="green" background="white" borderRadius="50%" ml="auto" _hover={{ background: "green", color: "white"}} p={1} onClick={() => {
